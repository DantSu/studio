...
public class DeviceUtils {
    ...
    public static short readAsciiToShort(InputStream is, int numberBytes) throws IOException {
        return Short.parseShort(new String(is.readNBytes(numberBytes), StandardCharsets.UTF_8));
    }

    public static long readAsciiToLong(InputStream is, int numberBytes) throws IOException {
        return Long.parseLong(new String(is.readNBytes(numberBytes), StandardCharsets.UTF_8));
    }
